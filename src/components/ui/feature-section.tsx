      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 mb-12">
          ...
          {illustrationSrc && (
            <div className="flex-shrink-0">
              <img src={illustrationSrc} alt={illustrationAlt} className="w-48 h-auto rounded-2xl" />
            </div>
          )}
        </div>
        ...
        >
          ...
          <motion.div
            ...
            className="mt-12"
          >
            <Button asChild size="lg" className="px-6 rounded-full bg-[#b9e2a0] text-[#0a2b00] hover:bg-[#a9d98b] hover:text-[#0a2b00]">
              <a href={buttonHref} style={{ color: '#0a2b00' }}>{buttonText}</a>
            </Button>
          </motion.div>
        </motion.div>
      </section>
